...
function ChiTiet(){
	...
	switch(tem[0]){
		...
		case '1':
		{
            ...
            var mausac = new Array("green", " yehlow","black", "red","Brown","green", " yellow","black")
