...
function sanpham(){
	...
	switch(tem[0]){
		...
		case '0':
		{
			var sp = new Array("Baloshop Zone","Baloshop Zone333","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone999","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone","Baloshop Zone888");
			var gia = new Array(150           ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            ,150            );
			src += './assets/img/balo/';
			break;
		}
		...
		case '6':
		{
			...
			for(i=vitri; i < sp.length; i++){
				dem++;
				s =s +  "<div class=\"cart-row\"><div class=\"portfolio-wrap\">" + "<img src=" + src + "balo5" + ".jpg class=\"img-fluid\" alt=\"\" width=\"415px\" height=\"315px\"><div class=\"portfolio-links\"><a href=\"\" title=\"More Details\" class=\"cart-title-item\">" + sp[i] + "</a><br/><b class=\"cart-price\">" + Number(gia[i]).toLocaleString() + "</b> </div></div></div>";
				if(dem == 18) break;
			}
