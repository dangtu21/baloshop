	...
	function kiemtraTenDangNhap(idtag){
		var tendangnhap = document.getElementById(idtag);
		var pthongbao = document.getElementById ("pthongbao");
		var reg = /^[a-zA-Z0-9]+$/;
		if(tendangnhap.value.match(reg)){
			pthongbao.style.display = "none";
			return true;
		}else{
			pthongbao.style.display = "block";
			pthongbao.innerHTML ="TÊN ĐĂNG NHẬP KHÔNG HỢP LỆ ";
			return false;
		}
	}
	...
	function kiemtraTuoi(minTuoi, maxTuoi, idTagThongBao){
		...
		if(tuoi.value.match(numbers))
		{
			...
			pthongbao.style.display = "block";
			pthongbao.innerHTML ="TUỔI PHẢI LÀ SỐ ";
			//theP.style.color = "red";
			return false;
		}
	}
	...
	function KiemTraHopLe(){
		return (ktraBatBuocDangKi() && kiemtrachieudaichuoi("tendangnhap",1,30) && kiemtraTenDangNhap("tendangnhap")
		&& kiemtraEmail("emailReg") && kiemtraTuoi(18,40,"pthongbao"));
